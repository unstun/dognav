"""Validate the Rev B candidate STEP in a clean FreeCAD import."""
...
document = App.newDocument("RevBRearWebStepValidation")
...
if not report["pass"]:
    raise RuntimeError("Rev B clean STEP import did not resolve to one valid solid")
