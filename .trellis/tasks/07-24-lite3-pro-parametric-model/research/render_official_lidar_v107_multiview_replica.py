#!/usr/bin/env python3
"""Render the image-reconstructed Lite3 LiDAR V1.0.7 candidate."""
...
FCSTD_PATH = (
    OUTPUT_ROOT
    / "models/lite3_lidar_v107_multiview_replica_candidate.FCStd"
)
...
def render() -> None:
    ...
    document = App.newDocument("Lite3_LiDAR_V107_Multiview_Replica")
    try:
        objects = {
