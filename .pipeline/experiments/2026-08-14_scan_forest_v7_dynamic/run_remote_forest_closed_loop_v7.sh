...
RUN_ID=$1
RUN_ROOT=${SCAN_V7_RUN_ROOT:-/home/sun/machine-dog-nav-runs/2026-08-14_scan_forest_v7_dynamic}
BASE_RUNNER=${SCAN_V7_BASE_RUNNER:-$RUN_ROOT/run_remote_closed_loop.sh}

export SCAN_RUN_ROOT=$RUN_ROOT
export SCAN_ENTRYPOINT=$0
export SCAN_FOXY_WORKSPACE=$RUN_ROOT/foxy_ws
export SCAN_ACCEPTANCE_CONFIG=${SCAN_V7_ACCEPTANCE_CONFIG:-$RUN_ROOT/acceptance_thresholds_v7_candidate.json}
...
export SCAN_COURSE=forest_gen_nav_v7_dynamic
# V7 keeps the V6 planner constants and adds only occupied-voxel freshness.
...
export SCAN_DYNAMIC_OBSTACLE_HEIGHT=${SCAN_DYNAMIC_OBSTACLE_HEIGHT:-1.50}
