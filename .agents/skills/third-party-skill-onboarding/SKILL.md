...
description: Use when Dr Sun asks to evaluate, install, copy, or adapt third-party skills from another repository into machine-dog-nav or another project-local .agents/skills directory.
---
...
8. Keep project-specific records in their correct harness location. For machine-dog-nav:
   - engineering vocabulary: `CONTEXT.md`
   - engineering decisions: `docs/adr/`
   - experiment contracts: `.pipeline/contracts/`
   - experiment records: `.pipeline/experiments/`
