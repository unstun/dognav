...
Current resources in references/upstream/:
{download_res}
...
1. Analyze the selected idea to identify technical components not yet available in `references/upstream/`
2. Use the "Cascade" search strategy (Level 1: Specific -> Level 2: Broad -> Level 3: Atomic) with 6 queries per gap
3. Clone candidate repos into `references/upstream/`
