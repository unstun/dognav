...
2. **Current Workspace**: Check `references/upstream/`. Do NOT assume standard libraries
...
| Clone a repository | `git clone --depth 1` | `git clone --depth 1 https://github.com/user/repo.git references/upstream/repo` |
| List files in a directory | `ls`, `find`, `tree` | `ls references/upstream/` |
| Read a file | `cat`, `head`, `tail` | `cat references/upstream/repo/README.md` |
| View repository structure | `tree` | `tree references/upstream/repo/ -L 3` |
| Search for text in files | `grep`, `rg` (ripgrep) | `grep -rn "attention" references/upstream/repo/` |
