...
description: Convert validated research state into publication-stage paper handoff tasks, claim evidence, figure/reference reminders, and delivery checklist.
version: 1.0.0
