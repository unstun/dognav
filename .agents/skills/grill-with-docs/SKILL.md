...
description: Grilling session that challenges a machine-dog-nav engineering plan against the existing domain model, sharpens terminology, and updates documentation (CONTEXT.md, ADRs) inline as decisions crystallise. Use when user wants to stress-test a plan against project language and documented engineering decisions.
---
...
Use this skill for engineering language and engineering decisions only.
...
When a discussion touches research claims, paper text, or experiment evidence, cite the relevant contract, experiment artifact, or project memory record instead of copying that content into `CONTEXT.md` or `docs/adr/`.
